...
export function IconRocket({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      <path
        d="M14.5 3.5c2.5 1 4 2.5 5 5-2.5 1-6 4.5-7 7l-3.5-.5-.5-3.5c2.5-1 6-6 6-8z"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M8.5 15.5L5 19M9 12c-1.5 0-3.5.5-4 4M12 15c0 1.5-.5 3.5-4 4"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function IconArrowUp({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
...
export function IconArrowDown({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
