    ...
    <div className="flex items-center gap-1.5">
        ...
        {open && (
          <>
            ...
            <div className="absolute left-0 right-0 top-full z-20 mt-1 overflow-hidden rounded-lg border border-[var(--db-border)] bg-[var(--db-surface)] shadow-lg">
              ...
              <Link
                href="/projects/new"
                className="flex items-center gap-1.5 border-t border-[var(--db-border)] px-3 py-2 text-left text-sm font-medium text-[var(--db-accent)] transition-colors hover:bg-[var(--db-surface-hover)]"
              >
      ...
      {current && (
        <Link
          ...
          title="Edit project"
          className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-[var(--db-border)] text-[var(--db-fg-muted)] transition-colors hover:border-[var(--db-border-strong)] hover:text-[var(--db-fg)]"
        >
